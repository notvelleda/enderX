...
class RootWindow extends Window {
    ...
    RootWindow(Container container, Screen screen, Format[] format, Client c) {
        ...
        /*if(rootwindow instanceof xyz.pugduddly.enderX.ui.Window){
          //((Frame)rootwindow).setLayout(null);
          ((xyz.pugduddly.enderX.ui.Window)rootwindow).setResizable(false);
          //((Frame)rootwindow).setMenuBar(null);
          ((xyz.pugduddly.enderX.ui.Window)rootwindow).add((java.awt.Component)ddxwindow);
        }
        else */
        if (rootwindow instanceof Applet) {
        ...
        */
        else if (screen.windowmode == WeirdX.InBrowser) {
        ...
        Window.focus.win = id;
        //System.out.println("RootWindow: focus " + id);
