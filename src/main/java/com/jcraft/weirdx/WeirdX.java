 ...
 * Modified for enderX 2.0 by Pugduddly (2018)
 *
...
public final class WeirdX extends Applet {
    ...
    public static final int releaseNumber = 1032; // 1.0.32
    public static final int motionBufferSize = 0;
    public static final int maxRequestLength = 65535;
    public static final byte[] vendor = "JCraft,Inc.".getBytes();
    ...
    public static short width = 640;
    public static short height = 480;

    static String visuals = "TrueColor16";
    ...
    void weirdx_init(Container container) {
        ...
        try {
            if (c != null) Keymap.km = (Keymap) c.newInstance();
        } catch (Exception e) {}
        c = null;
        ...
        try {
            if (c != null) Keymodifier.kmod = (Keymodifier) c.newInstance();
        } catch (Exception e) {}
    ...
    void weirdx_start(Container container) throws ConnectException {
        ...
        System.out.println("X server started on display :" + displaynum);
        ...
        try {
            ...
            while (true && weirdx != null) {
                ...
                if (!Acl.check(socket.getInetAddress())) {
                    ...
                    try {
                        EnderX.alert("ACL warning: unauthorized access from " + socket.getInetAddress());
                    } catch (Exception e) {}
    ...
    public static void init_enderX(int width, int height, Container container) {
        String s;
        WeirdX weirdx = new WeirdX();

        Properties props = new Properties();
        try {
            InputStream rs = weirdx.getClass().getResourceAsStream("/props");
            if (rs != null)
                props.load(rs);
        } catch (Exception e) {
            //System.err.println(e);
        ...
        try {
            ...
            WeirdX.width = (short) width;
            WeirdX.height = (short) height;
