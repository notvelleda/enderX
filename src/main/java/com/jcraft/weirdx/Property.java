	...
	w.setProperty(p);
      ...
      if(p!=null){
        ...
        if(w.screen.windowmode!=WeirdX.InBrowser &&
          ...
          p.size>0 &&
          w.ddxwindow!=null){
          xyz.pugduddly.enderX.ui.Window frame=w.getFrame();
          if(frame!=null && (frame instanceof xyz.pugduddly.enderX.ui.Window)){
            ((xyz.pugduddly.enderX.ui.Window)frame).setTitle(new String(p.data));
          }
        }
      }
    }
