...
public class Game extends Component implements Runnable {
	...
	private BufferedImage imageAlt = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_RGB);
	...
	public void render() {
        ...
        Graphics g = this.imageAlt.getGraphics();
        g.drawImage(image, 0, 0, null);
        g.dispose();
	}
    
    public void paint(Graphics g) {
        g.drawImage(this.imageAlt, 0, 0, this.getWidth(), this.getHeight(), null);
    }
