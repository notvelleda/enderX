...
/**
 * Window that uses VolatileImage(s) for drawing to instead of BufferedImage(s).
 * The contents of the window can be lost at any time.
 */
public class AcceleratedWindow extends Window {
     ...
     */
    public AcceleratedWindow(String title) {
        super(title);
        this.title = title;
    ...
    private void verifyCanvas(boolean recreate) {
        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
        GraphicsConfiguration gc = ge.getDefaultScreenDevice().getDefaultConfiguration();
        if (this.canvas == null || this.canvas.contentsLost() || this.canvas.validate(gc) == VolatileImage.IMAGE_INCOMPATIBLE || recreate) {
            if (this.canvas != null) {
                this.canvas.flush();
            }
            this.canvas = gc.createCompatibleVolatileImage((int) size.getWidth(), (int) size.getHeight(), Transparency.OPAQUE);
            this.canvas.setAccelerationPriority(1);
        }
    }
     ...
     */
    public AcceleratedWindow setSize(Dimension size) {
        this.size = size;
        verifyCanvas(true);
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setSize(int width, int height) {
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setPosition(Point pos) {
        this.position = pos;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setLocation(Point pos) {
        this.position = pos;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setLocation(int x, int y) {
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setClosable(boolean close) {
        this.close = close;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setResizable(boolean resize) {
        this.resize = resize;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setRollable(boolean roll) {
        this.roll = roll;
        return this;
    }
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow close() {
        this.canClose = true;
        this.onClose();
        System.gc();
        return this;
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow stopClose() {
        this.canClose = false;
        return this;
    }
     ...
     */
    public AcceleratedWindow setDragging(boolean dragging) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setDragOrigin(Point origin) {
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow setRoll(boolean rolled) {
        this.rolled = rolled;
        return this;
    }
     ...
     */
    public AcceleratedWindow add(java.awt.Component component) {
     ...
     * @see java.awt.Component xyz.pugduddly.enderX.ui.Component
     */
    public AcceleratedWindow remove(java.awt.Component component) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setResizing(boolean resizing) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setResizeOrigin(Point origin) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setMaximized(boolean maximized) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setOriginalSize(Dimension originalSize) {
     ...
     * Used by {@link xyz.pugduddly.enderX.ui.platinum.PlatinumDesktop}. Don't use it, please.
     */
    public AcceleratedWindow setOriginalPosition(Point pos) {
     ...
     */
    public AcceleratedWindow addKeyListener(KeyListener keyListener) {
     ...
     * @see java.awt.KeyListener
     */
    public AcceleratedWindow removeKeyListener(KeyListener keyListener) {
        if (keyListener == null) return null;
     ...
     */
    public AcceleratedWindow addMouseListener(MouseListener mouseListener) {
     ...
     * @see java.awt.MouseListener
     */
    public AcceleratedWindow removeMouseListener(MouseListener mouseListener) {
        if (mouseListener == null) return null;
     ...
     */
    public AcceleratedWindow addMouseMotionListener(MouseMotionListener mouseMotionListener) {
     ...
     * @see java.awt.MouseMotionListener
     */
    public AcceleratedWindow removeMouseMotionListener(MouseMotionListener mouseMotionListener) {
        if (mouseMotionListener == null) return null;
     ...
     */
    public AcceleratedWindow addComponentListener(ComponentListener componentListener) {
     ...
     * @see java.awt.ComponentListener
     */
    public AcceleratedWindow removeComponentListener(ComponentListener componentListener) {
        if (componentListener == null) return null;
     ...
     */
    public AcceleratedWindow addWindowListener(WindowListener windowListener) {
     ...
     * @see java.awt.WindowListener
     */
    public AcceleratedWindow removeWindowListener(WindowListener windowListener) {
        if (windowListener == null) return null;
     ...
     * @see #isVisible()
     */
    public AcceleratedWindow setVisible(boolean visible) {
     ...
     * @return the Window object, for convenience.
     */
    public AcceleratedWindow removeAll() {
